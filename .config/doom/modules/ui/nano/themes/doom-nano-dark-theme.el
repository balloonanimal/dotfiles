...
(def-doom-theme doom-nano-dark
  ...
  (;; structural
   ...
   ;; (show-paren-match :box `(:line-width -1 :color ,nano-color-foreground))
   (show-paren-match :inherit 'nano-face-salient)
   ...
   ;; diff
    ...
    ;; clojure
    (clojure-keyword-face :inherit '(font-lock-constant-face italic))

    ;; vertico
    (orderless-match-face-0 :inherit '(nano-face-faded nano-face-strong))
