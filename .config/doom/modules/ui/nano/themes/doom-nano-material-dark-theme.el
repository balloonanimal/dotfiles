;; FIXME this needs to be changed every time that I change the other nano theme
;; TODO make nano-theme a macro so I don't have to do this

(setq nano-color-foreground "#EEEEEE") ;; Grey 300
(setq nano-color-background "#212121") ;; Grey 900
(setq nano-color-highlight  "#424242") ;; Grey 800
(setq nano-color-critical   "#e53935") ;; Red 600
(setq nano-color-salient    "#7aa2f7") ;;
(setq nano-color-strong     "#EEEEEE") ;;
(setq nano-color-popout     "#ff9e64") ;;
(setq nano-color-subtle     "#616161") ;;
(setq nano-color-faded      "#9E9E9E") ;;
(nano-faces)
...
(defgroup doom-nano-material-dark-theme nil
  "Options for doom-themes"
  :group 'doom-themes)

(def-doom-theme doom-nano-material-dark
  ...
  (;; structural
   ...
   ;; FIXME: figure out whether this should just be default
   (bookmark-face :inherit 'nano-face-subtle)
