...
(defvar +doom-dashboard-functions
  '(doom-dashboard-widget-banner z/small-test-splash)
...
(defun doom-dashboard-draw-ascii-banner-fn () (let* ((banner
          '("=================     ===============     ===============   ========  ========"
            "\\\\ . . . . . . .\\\\   //. . . . . . .\\\\   //. . . . . . .\\\\  \\\\. . .\\\\// . . //"
            "||. . ._____. . .|| ||. . ._____. . .|| ||. . ._____. . .|| || . . .\\/ . . .||"
            "|| . .||   ||. . || || . .||   ||. . || || . .||   ||. . || ||. . . . . . . ||"
...
;; (defun z/splash-screen-init-h ()
;;   "Initializes my custom splash screen"
;;   (unless noninteractive
;;     (setq doom-fallback-buffer-name "*splash*"
;;           initial-buffer-choice #'doom-fallback-buffer)
;;     (when (equal (buffer-name) "*splash*")
;;       (set-window-buffer nil (doom-fallback-buffer))
;;       (z/splash-screen-reload))))

;; (add-hook 'doom-init-ui-hook #'z/splash-screen-init-h)

;; (defun z/splash-screen-reload ()
;;   (with-current-buffer (doom-fallback-buffer)
;;     (insert "TESTING SPLASH SCREEN")))
