...
(setq
 ...
 z/font-variable-sans "Noto Sans"
...
I also like to have my window dividers large and styled with the same color as the background. While the lack of a color distinction risks making it difficult to notice window boundaries the large size of margins fixes this problem.
#+begin_src emacs-lisp
...
TODO
No rainbow parens, we highlight the surrounding sexp instead.
